...
final class ReportPageRowHelper {
    ...
    static ReportPageRow getRow() {
        return getRow(0, null, cell(null, 1), cell("", 2), cell(" ", 3), cell(123, 4), cell(1.23, 5), cell(BigDecimal.valueOf(1), 6), cell("test word", 9), cell("This Is Sparta", 10), cell("London\nis the\ncapital\nof Great Britain", 20), cell("The Mac\rnew line", 21), cell("The Windows\r\nnew line", 22));
    }
    ...
    static ReportPageRow[] getThreeRowsHeader() {
        ...
        rows[0] = getRow(0, null, cell("One", 1), cell("Two", 20), cell("Three", 30));
        rows[1] = getRow(1, null, cell("a1", 1), cell("a2", 5), cell("a1", 11), cell("a2", 15), cell("a1", 21), cell("a2", 25));
        rows[2] = getRow(2, null, cell("b1", 1), cell("b2", 2), cell("b1", 5), cell("b2", 6), cell("b1", 11), cell("b2", 12), cell("b1", 15), cell("b2", 16), cell("b1", 21), cell("b2", 22), cell("b1", 25), cell("b2", 26));
        return rows;
    }
