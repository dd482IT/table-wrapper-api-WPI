...
public abstract class AbstractTable<R extends ReportPageRow> implements Table {
    ...
    public <T> List<T> getDataCollection(Object report, Function<TableRow, @Nullable Collection<T>> rowExtractor, BiPredicate<T, T> equalityChecker, BiFunction<T, T, @Nullable Collection<T>> mergeDuplicates) {
        return getDataCollection(report, (row, data) -> {
            @Nullable
            Collection<T> result = rowExtractor.apply(row);
            if (result != null) {
    ...
    public static <T> void addWithEqualityChecker(T element, Collection<T> collection, BiPredicate<T, T> equalityChecker, BiFunction<T, T, @Nullable Collection<T>> duplicatesMerger) {
        @Nullable
        T equalsObject = null;
        for (T e : collection) {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (this.dataRowOffset != other.dataRowOffset) return false;
        final java.lang.Object this$reportPage = this.getReportPage();
        final java.lang.Object other$reportPage = other.getReportPage();
        if (this$reportPage == null ? other$reportPage != null : !this$reportPage.equals(other$reportPage)) return false;
        ...
        if (this$tableRange == null ? other$tableRange != null : !this$tableRange.equals(other$tableRange)) return false;
        ...
        if (this$headerDescription == null ? other$headerDescription != null : !this$headerDescription.equals(other$headerDescription)) return false;
        return true;
    }
