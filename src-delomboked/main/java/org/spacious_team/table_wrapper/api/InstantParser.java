...
public class InstantParser {
    ...
    @java.lang.SuppressWarnings("all")
    InstantParser(@Nullable final DateTimeFormatter dateTimeFormatter, @Nullable final LocalDate defaultDate, final LocalTime defaultTime, final ZoneId defaultZoneId) {
    ...
    public static class InstantParserBuilder {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public InstantParser.InstantParserBuilder dateTimeFormatter(@Nullable final DateTimeFormatter dateTimeFormatter) {
            this.dateTimeFormatter = dateTimeFormatter;
            return this;
        }
         ...
         */
        @java.lang.SuppressWarnings("all")
        public InstantParser.InstantParserBuilder defaultDate(@Nullable final LocalDate defaultDate) {
            this.defaultDate = defaultDate;
            return this;
        }
