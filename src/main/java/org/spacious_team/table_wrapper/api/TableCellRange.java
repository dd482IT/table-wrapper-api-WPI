...
public class TableCellRange {
    ...
    public static TableCellRange of(TableCellAddress upperLeft, TableCellAddress bottomRight) {
        return of(upperLeft.getRow(), bottomRight.getRow(), upperLeft.getColumn(), bottomRight.getColumn());
    }
    ...
    @java.lang.SuppressWarnings("all")
    private TableCellRange(final int firstRow, final int lastRow, final int firstColumn, final int lastColumn) {
    ...
    @java.lang.SuppressWarnings("all")
    public static TableCellRange of(final int firstRow, final int lastRow, final int firstColumn, final int lastColumn) {
        return new TableCellRange(firstRow, lastRow, firstColumn, lastColumn);
    }
}
