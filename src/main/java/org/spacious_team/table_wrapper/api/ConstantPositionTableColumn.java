...
public class ConstantPositionTableColumn implements TableColumn {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof ConstantPositionTableColumn)) return false;
        final ConstantPositionTableColumn other = (ConstantPositionTableColumn) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof ConstantPositionTableColumn;
    }
    ...
    public int hashCode() {
        final int PRIME = 59;
        int result = 1;
        result = result * PRIME + this.columnIndex;
        return result;
    }
