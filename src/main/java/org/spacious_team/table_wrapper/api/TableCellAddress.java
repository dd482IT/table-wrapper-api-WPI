...
public class TableCellAddress {
    ...
    @java.lang.SuppressWarnings("all")
    private TableCellAddress(final int row, final int column) {
        this.row = row;
        this.column = column;
    }

    @java.lang.SuppressWarnings("all")
    public static TableCellAddress of(final int row, final int column) {
        return new TableCellAddress(row, column);
    }
}
